            ...
            <div class="container">
                ...
                <div class="bg-white rounded-4 shadow-sm overflow-hidden">
                    ...
                    <div class="d-flex gap-2 mb-3">
                        <a href="{{ route('admin.ekstrakurikuler.export.excel') }}" class="btn btn-success">
                            <i class="bi bi-file-earmark-excel me-1"></i> Export Excel
                        </a>

                        <a href="{{ route('admin.ekstrakurikuler.export.pdf') }}" class="btn btn-danger">
                            <i class="bi bi-file-earmark-pdf me-1"></i> Export PDF
                        </a>
                    </div>

                    <div class="table-responsive">
                        <table id="tabel-ekstrakurikuler" class="table table-hover align-middle mb-0">
