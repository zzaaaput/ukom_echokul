      ...
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        @if(Auth::user()->role === 'admin')
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Daftar</a>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('admin.kegiatan.index') }}">Kegiatan</a></li>
            ...
            {{-- Aktivitas --}}
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Aktivitas</a>
              <ul class="dropdown-menu">
        ...
        @if(Auth::user()->role === 'pembina')
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Daftar</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('pembina.anggota.index') }}">Anggota</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Informasi</a>
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ route('pembina.kegiatan.index') }}">Kegiatan</a></li>
                <li><a class="dropdown-item" href="{{ route('pembina.pengumuman.index') }}">Pengumuman</a></li>
